...
///Inicia clase de Apostila,  presenta informacion en un ListView.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          new Expanded(
            ///Informacion en ListView.
            child: ListView(
              children: <Widget>[
                ///Cuando el usuario despliega cualquier opcion presentada en un title de cada ExpansionTitle,
                ///
                ///muestra informacion correspondiente.
                ///ObjetivosPrograma.
                ExpansionTile(
                  ...
                  children: [
                    ListTile(
                      subtitle: Text(
                          'Regular y establecer la operación del trámite y prestación del servicio de gestión de documentos de identidad americanos “Para facilitar la inserción de actas extranjeras para obtener la doble nacionalidad',
                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    ...
                    requitoPrograma(
                        "RFC (impreso) con la hoja del SAT de quien va a realizar el trámite"),
                      ...
                      title: Row(
                        children: <Widget>[
                          ...
                          new Expanded(
                            flex: 10,
                            child: InkWell(
                              ///Dentro de ListeTile, muestra un PDF y da la opcion de descargar.
                              onTap: () {
                                customLaunch(
                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    ...
                    ///Muestra contacto, usando nuevamente customLaunch para direccionar
                    /// a la mensajeria instantanea de whastapp a un numero personalizado.
                    ListTile(
                      leading: new Icon(FontAwesomeIcons.whatsapp),
                      title: Text('Teléfono'),
                      subtitle: Text('+52 492 892 26 38'),
                      onTap: () {
                        customLaunch("whatsapp://send?phone=+524928922638");
                      },
                    )
                  ],
                )
