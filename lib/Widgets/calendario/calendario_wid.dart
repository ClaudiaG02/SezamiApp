...
class _CalendarioState extends State<Calendario> {
  ...
  ///
  /// [select]. [even]. [hoy].tipo boleano.
  /// [eventos_es].[eventos_all]. [jsonall] Inicializadas en null o un vacio.
  bool select = false;
  String even;
  String hoy;
  var eventos_es = [];
  ...
  ///Inicia metodo [_buildTableCalendar].
  ...
  _returnlistafechaseventos(String f) {
    Firestore.instance
        ...
        ///Tomando la coleccion [eventos_calendario].
  ...
  ///Usando el mecanismo Switch-Case, para control de selección.
  ///
  ///Para usar el Switch-Case, se inicio una variable llamada[retumespal].
  ///Evaluando la variable de [mes].
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ExpansionTile(
                ...
                ///Muestra la lista de los eventos en un ListTile.
                children: <Widget>[
                  ListTile(
