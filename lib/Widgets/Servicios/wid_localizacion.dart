...
///Clase Localizacion
///La funcionalidad de Localizacion de Personas es un poco similar a Asesoria migratoria
///Contiene TextFiel en donde perimte alusuario ingresar datos  de la persona a buscar asi como del solicitante.
                ...
                child: new Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ///En la linea 114 [controller: nombre] suministra el TextEditingController a un TextField
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: FlatButton(
                                            onPressed: () {
                                              ///Cuando la opcion sea seleccionada, se muestra una función que viene en Material
                                              ///[showDatePicker] que muestra un Dialog con un calendario.
                                            ...
                                            ///La fecha que seeccione el usuario se guardara en la variable [dan].
                                            child: Text(
                                              '$dan',
                                              style: TextStyle(
                                                  color: Color(0xff838383)),
                      ...
                      ////// [controller: nomsoli] suministra el TextEditingController a un TextField
                      Padding(
                        padding: const EdgeInsets.all(2.0),
                        child: TextField(
                          controller: nomsoli,
                      ...
                      ////// [controller: parsoli] suministra el TextEditingController a un TextField
                      TextField(
                        controller: parsoli,
                        maxLength: 18,
                        decoration: InputDecoration(
                      ...
                      /// [controller: telsoli] suministra el TextEditingController a un TextField
                      TextField(
                        controller: telsoli,
                        maxLength: 10,
                        decoration: InputDecoration(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: FlatButton(
                                            ...
                                            child: Text(
                                              ///La fecha que seleccione el usuario se almacena temporalmente en la variable[daf].
                                              '$daf',
                                              style: TextStyle(
                                                  color: Color(0xff838383)),
                                            ))),
                      ...
                      /// [controller: direccionu] suministra el TextEditingController a un TextField
                      TextField(
